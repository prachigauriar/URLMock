Pod::Spec.new do |s|
  ...
  s.source_files  = 'Sources/URLMock/Headers/Public/URLMock/URLMock.h',
  ...
  s.subspec 'TestHelpers' do |ss|
    ss.source_files = 'Sources/URLMock/Headers/Public/URLMock/NSURL+UMKQueryParameters.h',
  ...
  s.subspec 'SubclassResponsibility' do |ss|
    ...
    ss.source_files = 'Sources/URLMock/Headers/Public/URLMock/NSException+UMKSubclassResponsibility.h',
